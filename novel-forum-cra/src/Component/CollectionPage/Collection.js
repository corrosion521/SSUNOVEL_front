...
function Collection({ data }) {
    ...
    return (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: "100%", height: '100%' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', width: '100%', minHeight: '15%', boxSizing: 'border-box', paddingTop: '5%' }}>
                <h3 style={{ margin: '0', fontSize: '18px' }}>{data.title}</h3>
            </div>
            <h3 style={{ fontWeight: 'normal', fontSize: '15px', marginTop: '10%' }}>{" [ " + data.itemCnt + " ]"}</h3>
